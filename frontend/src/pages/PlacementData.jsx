...
const PlacementData = () => {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      const res = await axios.post("https://eduvision-r00l.onrender.com:5000/upload", formData);
  ...
  const applyFilters = async () => {
    try {
      const res = await axios.post("https://eduvision-r00l.onrender.com:5000/filter", { filters });
  ...
  const applyColumnChanges = async () => {
    try {
      const res = await axios.post("https://eduvision-r00l.onrender.com:5000/apply-column-changes", {
